...
public class D11_ReporterList {
	...
	public static String reporters = "조선일보 가정/육아 박은주 \r\n"
			+ "문화일보 가정/육아 박양수 \r\n"
			+ "경향신문 가정/육아 황경상 \r\n"
			+ "동아일보 가정/육아 우경임 \r\n"
			+ "동아일보 가정/육아 정효진 \r\n"
			...
			+ "아이뉴스24 게임/E 스포츠 구윤희 yuni@inews24.com \r\n"
			+ "조선일보 게임/E 스포츠 이관우 temz@chosun.com \r\n"
			+ "동아일보 게임/E 스포츠 김남규 rain@gamedonga.co.kr \r\n"
			+ "동아일보 게임/E 스포츠 김형근 noarose@gamedonga.co.kr \r\n"
			+ "동아일보 게임/E 스포츠 최호경 neoncp@gamedonga.co.kr \r\n"
			+ "중앙일보 게임/E 스포츠 박명기 mkpark@joongang.co.kr \r\n"
			+ "조선일보 게임/E 스포츠 최종배 jovia@chosun.com \r\n"
			+ "서울경제 게임/E 스포츠 임지훈 jhlim@sed.co.kr \r\n"
			+ "노컷뉴스 게임/E 스포츠 지봉철 janus@nocutnews.co.kr \r\n"
			+ "조선일보 게임/E 스포츠 편집국 gamedesk@chosun.com \r\n"
			+ "조선일보 게임/E 스포츠 곽승훈 european@sportschosun.com \r\n"
			+ "동아일보 게임/E 스포츠 김한준 endoﬂife81@gamedonga.co.kr \r\n"
			+ "지디넷코리아 게임/E 스포츠 봉성창 bong@zdnet.co.kr \r\n"
			...
			+ "MBC 뉴스 노동 김재영 jaykim@mbc.co.kr \r\n"
			...
			+ "한겨례 다이어트정보 현시원 sonvadak25@hanmail.net \r\n"
			+ "한겨례 다이어트정보 박두원 p7@mkmedia.co.kr \r\n"
			+ "한겨례 다이어트정보 남은주 mifoco@hani.co.kr \r\n"
			+ "한겨례 다이어트정보 박미향 mh@hani.co.kr \r\n"
			+ "한겨례 다이어트정보 정혁준 june@hani.co.kr \r\n"
			+ "아시아 다이어트정보 신범수 answer@asiae.co.kr \r\n"
			+ "한겨례 다이어트정보 양선아 anmadang@hani.co.kr \r\n"
			...
			+ "MBC 뉴스 도로/교통 노재필 jaepil@imbc.com \r\n"
			...
			+ "굿데이 스포츠디지털뉴스팀 김계준 kkj@gooddaysports.co.kr \r\n"
			...
			+ "한겨례 문화인물스케치 정상연 chung@hani.co.kr \r\n"
			...
			+ "연합뉴스 빛나는문화유산 현윤경 ykhyun14@yna.co.kr \r\n"
			+ "문화일보 빛나는문화유산 최영창 ycchoi@munhwa.com \r\n"
			+ "연합뉴스 빛나는문화유산 김태식 taeshik@yna.co.kr \r\n"
			+ "조선일보 빛나는문화유산 조호진 superstory@chosun.com \r\n"
			+ "한국경제 빛나는문화유산 서화동 ﬁreboy@hankyung.com \r\n"
			...
			+ "MBC 뉴스 사회 송양환 rainbow@mbc.co.kr \r\n"
			...
			+ "MBC 뉴스 사회 고은상 gotostorm@naver.com \r\n"
			...
			+ "weekly 경향 생활경제 서상준 ssjun@kyunghyang.com \r\n"
			...
			+ "조선일보 생활정보/트렌드 김나라 ﬂaras@chosun.com \r\n"
			...
			+ "한겨례 언론/미디어 김남일 namﬁc@hani.co.kr \r\n"
			...
			+ "동아일보 언론/미디어 이태훈 jeﬄee@donga.com \r\n"
			...
			+ "연합뉴스 언론/미디어 강건택 ﬁrstcircle@yna.co.kr \r\n"
			...
			+ "K 모바일 인터넷 홍민기 news@kmobile.co.kr \r\n"
			+ "MBC 뉴스 인터넷/컨텐츠 조현용 star@mbc.co.kr \r\n"
			...
			+ "서울경제 차업계새소식 심희정 yvette@sed.co.kr \r\n"
			+ "파이낸셜 차업계새소식 조용성 yscho@fnnews.com \r\n"
			+ "조선일보 차업계새소식 최원석 ws-choi@chosun.com \r\n"
			+ "이데일리 차업계새소식 김경민 min07@edaily.co.kr \r\n"
			+ "한국경제 차업계새소식 이미아 mia@hankyung.com \r\n"
			+ "노컷뉴스 차업계새소식 양승진 broady01@cbs.co.kr \r\n"
			...
			+ "MBC 뉴스 차업계새소식 서혜연 hyseo@mbc.co.kr \r\n"
			...
			+ "MBC 뉴스 컴퓨터/보안 박영회 nofootbird@imbc.com \r\n"
	...
	/*
	 	...
	 	1. 어떤 이메일 도메인(yna.co.kr, kankyung.com 등)이
	 	   몇 개씩 있는지 세어서 출력해보기
	...
	public static void main(String[] args) {
		Pattern reporterPattern = Pattern.compile("(\\S+)\\s(\\S+)\\s(\\S+)\\s(\\w+[@](\\w+)\\.\\w+\\.*\\w+)");
		Matcher reporterMatcher = reporterPattern.matcher(reporters);
		
		ArrayList<Reporter> arr = new ArrayList<>();
		HashMap<String, Integer> domainCnt = new HashMap<>();
		HashMap<String, Integer> reporterCnt = new HashMap<>();
		HashMap<String, Integer> categoryCnt = new HashMap<>();
		
		while (reporterMatcher.find()) {
			System.out.println("신문사 : " + reporterMatcher.group(1));
			System.out.println("분야 : " + reporterMatcher.group(2));
			System.out.println("이름 : " + reporterMatcher.group(3));
			System.out.println("이메일 :" + reporterMatcher.group(4));
			
			String newsStand = reporterMatcher.group(1);
			String category = reporterMatcher.group(2);
			String repName = reporterMatcher.group(3);
			String repEmail = reporterMatcher.group(4);
			String domain = reporterMatcher.group(5);
			
			arr.add(new Reporter(newsStand, category, repName, repEmail));
			
			domainCnt.put(domain, domainCnt.getOrDefault(domain, 0) + 1);
			reporterCnt.put(newsStand, reporterCnt.getOrDefault(newsStand, 0) + 1);
			categoryCnt.put(category, categoryCnt.getOrDefault(category, 0) + 1);
		}
		
		HashMap<String, List<Reporter>> sortNewsStand = new HashMap<>();
		HashMap<String, List<Reporter>> sortCategory = new HashMap<>();
		
		for (Reporter reporter : arr) {
			String newsStandName = reporter.getCompany();
			
			if (sortNewsStand.containsKey(newsStandName)) {
				sortNewsStand.get(newsStandName).add(reporter);
			} else {
				ArrayList<Reporter> list = new ArrayList<>();
				list.add(reporter);
				sortNewsStand.put(newsStandName, list);
			}
		}
		
		for (String newsStandName : sortNewsStand.keySet()) {
			System.out.println(newsStandName + "기자들");
			
			for (Reporter rep : sortNewsStand.get(newsStandName)) {
